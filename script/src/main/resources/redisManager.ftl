...
<#list methods as method>
     ...
     * @auth linzh
     */
    public ${method.returnType} ${method.name}(<#list method.args as arg>final ${arg} arg${arg_index}<#if arg_has_next>, </#if></#list>) {
        return new RedisExecutor<${method.returnType}>() {
            @Override
            ${method.returnType} execute() {
                return jedis.${method.name}(<#list method.args as arg>arg${arg_index}<#if arg_has_next>, </#if></#list>);
            }
        }.getResult();
    }
</#list>
