 ...
 */
package com.rocyuan.commons.utils.quartz.util;


import com.rocyuan.commons.utils.quartz.job.AsyncJobFactory;
import com.rocyuan.commons.utils.quartz.job.SyncJobFactory;
...
public class ScheduleUtils {
    ...
    public static void createNotifyScheduleJob (Scheduler scheduler, ScheduleJob scheduleJob ) {
    	boolean isSync = scheduleJob.getIsSync();
       ...
       // SimpleScheduleBuilder.repeatMinutelyForTotalCount(10, 20).build();
     ...
     * @param cronExpression the cron expression
     * @param isSync the is sync
     * @param param the param  :  统一传入ScheduleJob
     */
    public static void updateScheduleJob(Scheduler scheduler, String jobName, String jobGroup,
                                         String cronExpression, boolean isSync, Object param) {

        //同步或异步
//        Class<? extends Job> jobClass = isSync ? SyncJobFactory.class : JobFactory.class;
